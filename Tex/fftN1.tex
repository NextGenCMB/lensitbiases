...
\end{equation}
\color{red} Not sure of the implication of my using $\bl_2 = \bl - \bll/2$ instead of $\bl_2 = \bll/2 - \bl$ for the trigo factors. If using the second version (probably better) this still holds
\color{black}
